...
def translate_text(input_text, target_language="chinese"):#{target_language} 
    # Messages formatés pour le modèle
    messages = [
        {"role": "system", "content": f"You are a translator translating to English. you will be provided content and will output only the translation"},
